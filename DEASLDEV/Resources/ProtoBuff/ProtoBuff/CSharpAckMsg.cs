...
// Generated from: CSharpAckMsg.proto
namespace LTLMoPCsharpInterface
{
    ...
    private LTLMoPCsharpInterface.CSharpAckMsg.SensorType _type = LTLMoPCsharpInterface.CSharpAckMsg.SensorType.LIDAR;
    [global::ProtoBuf.ProtoMember(1, IsRequired = false, Name=@"type", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)][global::System.ComponentModel.DefaultValue(LTLMoPCsharpInterface.CSharpAckMsg.SensorType.LIDAR)]
    public LTLMoPCsharpInterface.CSharpAckMsg.SensorType type
    {
      get { return _type; }
      set { _type = value; }
    }
    ...
    [global::ProtoBuf.ProtoMember(2, IsRequired = false, Name=@"stat", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)][global::System.ComponentModel.DefaultValue(default(double))]
    public double stat
    {
      get { return _stat; }
      set { _stat = value; }
    }
    private readonly global::System.Collections.Generic.List<double> _data = new global::System.Collections.Generic.List<double>();
    [global::ProtoBuf.ProtoMember(3, Name=@"data", DataFormat = global::ProtoBuf.DataFormat.TwosComplement, Options = global::ProtoBuf.MemberSerializationOptions.Packed)]
    public global::System.Collections.Generic.List<double> data
    {
      get { return _data; }
    }
